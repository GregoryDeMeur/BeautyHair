      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav">
          <li class="nav-item px-2">
            <a href="/BeautyHair/UserController/user/Dashboard" class="nav-link active">Dashboard</a>
          </li>
          <li class="nav-item px-2">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown mr-3">
            ...
            <div class="dropdown-menu">
              <a href="/BeautyHair/UserController/user/edit_profile" class="dropdown-item" data-toggle="dropdown-item">
