      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="card-body">
                ...
                <a href="/BeautyHair/ManagerController/deleteAppointment/<?php echo $appointment[0]['ID']?>">
                <button type="button" class="btn btn-danger">
                <i class="fas fa-trash-alt m-1"></i>
                Supprimer le rendez-vous
                </button>
                </a>    
                <button style="background-color: #061630;" class="btn text-white ml-4" data-dismiss="modal">Retour sans suppression</button>
                </div>
